return {
	"SalvatoreSantoro/springboot-nvim", -- Plugin repository
	branch = "changes_to_improved_package_detection",
    dependencies = {
	...
	config = function()
		...
		springboot_nvim.setup({}) -- <---- Dava problemi sovrascrivendo i file controllare meglio
	end,
}
